...
while True:
    ...
    if wlan.isconnected() and FAILED_MQTT == 1:
    	send('board2/co2_scd', str(co2), FAILED_CONNECTION_CO2)
    	send('board2/humid_scd', str(hum), FAILED_CONNECTION_CO2)
    	send('board2/temp_scd', str(temp), FAILED_CONNECTION_CO2)
    	send('board2/co', str(co), FAILED_CONNECTION_CO)
    	send('board2/o2', str(o2), FAILED_CONNECTION_O2)
    	send('board2/amb_press', str(pressure), FAILED_CONNECTION_BMP)
    	send('board2/temp1_am', str(tempa1), FAILED_CONNECTION_A1)
    	send('board2/humid1_am', str(huma1), FAILED_CONNECTION_A1)
    	send('board2/temp2_am', str(tempa2), FAILED_CONNECTION_A2)
    	send('board2/humid2_am', str(huma2), FAILED_CONNECTION_A2)
    	send('board2/temp3_am', str(tempa3), FAILED_CONNECTION_A3)
    	send('board2/humid3_am', str(huma3), FAILED_CONNECTION_A3)
    	send('board2/temp4_am', str(tempa4), FAILED_CONNECTION_A4)
    	send('board2/humid4_am', str(huma4), FAILED_CONNECTION_A4)
    else:
        do_connect()
        connect_mqtt()
